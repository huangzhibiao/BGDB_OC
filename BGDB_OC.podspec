...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  简约时尚强憾版存储框架,完美支持iOS大部分类型数据的存储,同时带有 字典转模型 功能模块.
                   DESC

  s.homepage     = "https://github.com/huangzhibiao/BGDB_OC"
  ...
  s.source       = { :git => "https://github.com/huangzhibiao/BGDB_OC.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "BGDB_OC/BGDB/*.{h,m}"
  #s.exclude_files = "BGDB_OC/BGDB"
